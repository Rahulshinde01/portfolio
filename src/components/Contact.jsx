const socialLinks = [
    {
      href: 'https://github.com/Rahulshinde01',
    ...
    {
      href: 'https://www.linkedin.com/in/rahul-shinde-95b589229/',
      icon: <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/shinde_rahul10/',
      icon: <svg width="30" height="30" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Contact = () => {
  return (
    ...
    className="section"
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch mb-12">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                Get in touch with me, I&apos;m open to new opportunities!
                ...
                <div className="flex items-center gap-2">
                    {socialLinks.map(({href, icon}, key)=>(
                        ...
                        href={href}
                        target="_blank"
                        className="w-12 h-12 grid place-items-center ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form
            action="https://getform.io/f/bllleklb"
            method="POST"
